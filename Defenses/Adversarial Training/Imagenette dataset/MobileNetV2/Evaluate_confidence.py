...
ds_train = tf.keras.preprocessing.image_dataset_from_directory(
    "/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/Imagenette/train",
    labels="inferred",
...
ds_test = tf.keras.preprocessing.image_dataset_from_directory(
    "/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/Imagenette/val",
    labels="inferred",
    label_mode="categorical",
    color_mode="rgb",
    batch_size=batch_size,
...
export_path = "/home/pbenga2s/RnD/Imagenette_advdef/saved_models/MobileNet/MobileNet_model(0.0001)"
model = tf.keras.models.load_model(export_path)
model.evaluate(ds_test)



patched_images_40p_class1_data_path = '/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/patch/class1/patched_images_40p_data.npy'
patched_images_35p_class1_data_path = '/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/patch/class1/patched_images_35p_data.npy'
patched_images_25p_class1_data_path = '/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/patch/class1/patched_images_25p_data.npy'
patched_images_20p_class1_data_path = '/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/patch/class1/patched_images_20p_data.npy'

patched_images_40p_class3_data_path = '/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/patch/class3/patched_images_40p_data.npy'
patched_images_35p_class3_data_path = '/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/patch/class3/patched_images_35p_data.npy'
patched_images_25p_class3_data_path = '/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/patch/class3/patched_images_25p_data.npy'
patched_images_20p_class3_data_path = '/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/patch/class3/patched_images_20p_data.npy'

patched_images_40p_class6_data_path = '/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/patch/class6/patched_images_40p_data.npy'
patched_images_35p_class6_data_path = '/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/patch/class6/patched_images_35p_data.npy'
patched_images_25p_class6_data_path = '/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/patch/class6/patched_images_25p_data.npy'
patched_images_20p_class6_data_path = '/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/patch/class6/patched_images_20p_data.npy'

patched_images_40p_class7_data_path = '/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/patch/class7/patched_images_40p_data.npy'
patched_images_35p_class7_data_path = '/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/patch/class7/patched_images_35p_data.npy'
patched_images_25p_class7_data_path = '/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/patch/class7/patched_images_25p_data.npy'
patched_images_20p_class7_data_path = '/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/patch/class7/patched_images_20p_data.npy'

patched_images_40p_class9_data_path = '/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/patch/class9/patched_images_40p_data.npy'
patched_images_35p_class9_data_path = '/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/patch/class9/patched_images_35p_data.npy'
patched_images_25p_class9_data_path = '/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/patch/class9/patched_images_25p_data.npy'
patched_images_20p_class9_data_path = '/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/patch/class9/patched_images_20p_data.npy'
...
plt.savefig("/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/output/class1.png",bbox_inches='tight')
plt.savefig("/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/output/class1.pdf",bbox_inches='tight')
plt.clf()
...
plt.ylabel('Confidence Level')
plt.title('Model Confidence Level Plot')
plt.savefig("/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/output/class3.png",bbox_inches='tight')
plt.savefig("/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/output/class3.pdf",bbox_inches='tight')
...
plt.ylabel('Confidence Level')
plt.title('Model Confidence Level Plot')
plt.savefig("/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/output/class6.png",bbox_inches='tight')
plt.savefig("/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/output/class6.pdf",bbox_inches='tight')
plt.clf()
...
plt.ylabel('Confidence Level')
plt.title('Model Confidence Level Plot')
plt.savefig("/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/output/class7.png",bbox_inches='tight')
plt.savefig("/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/output/class7.pdf",bbox_inches='tight')
plt.clf()
...
plt.ylabel('Confidence Level')
plt.title('Model Confidence Level Plot')
plt.savefig("/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/output/class9.png",bbox_inches='tight')
plt.savefig("/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/output/class9.pdf",bbox_inches='tight')
plt.clf()
...
plt.clf()
data13679 = np.hstack((data0,data13))
data13679 = np.hstack((data13679,data12))
data13679 = np.hstack((data13679,data11))
data13679 = np.hstack((data13679,data14))
data13679 = np.hstack((data13679,data34))
...
df = pd.DataFrame(data13679,columns=['clean(without patch)','class1_20p', 'class1_25p', 'class1_35p','class1_40p','class3_20p', 'class3_25p', 'class3_35p','class3_40p','class6_20p', 'class6_25p', 'class6_35p','class6_40p','class7_20p', 'class7_25p', 'class7_35p','class7_40p','class9_20p', 'class9_25p', 'class9_35p','class9_40p'])
# a=plt.ylabel('confidence level')
...
plt.ylabel('Confidence Level')
plt.title('Model Confidence Level Plot')
plt.savefig("/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/output/class13679.png",bbox_inches='tight')
plt.savefig("/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/output/class13679.pdf",bbox_inches='tight')
...
plt.ylabel('Confidence Level')
plt.title('Model Confidence Level Plot')
plt.savefig("/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/output/class13679_1.png",bbox_inches='tight')
plt.savefig("/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/output/class13679_1.pdf",bbox_inches='tight')
...
plt.xlabel('Patch Size')
plt.ylabel('Confidence Level')
plt.title('Model Confidence Level Plot - Ball Class')
plt.savefig("/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/output/class1_2.png",bbox_inches='tight')
plt.savefig("/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/output/class1_2.pdf",bbox_inches='tight')
plt.clf()
...
plt.xlabel('Patch Size')
plt.ylabel('Confidence Level')
plt.title('Model Confidence Level Plot - Cutting Machine Class')
plt.savefig("/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/output/class3_2.png",bbox_inches='tight')
plt.savefig("/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/output/class3_2.pdf",bbox_inches='tight')
...
plt.xlabel('Patch Size')
plt.ylabel('Confidence Level')
plt.title('Model Confidence Level Plot - Musical Instrument Class')
plt.savefig("/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/output/class6_2.png",bbox_inches='tight')
plt.savefig("/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/output/class6_2.pdf",bbox_inches='tight')
plt.clf()
...
plt.xlabel('Patch Size')
plt.ylabel('Confidence Level')
plt.title('Model Confidence Level Plot - Parachute Class')
plt.savefig("/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/output/class7_2.png",bbox_inches='tight')
plt.savefig("/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/output/class7_2.pdf",bbox_inches='tight')
plt.clf()
...
plt.xlabel('Patch Size')
plt.ylabel('Confidence Level')
plt.title('Model Confidence Level Plot - Radio Class')
plt.savefig("/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/output/class9_2.png",bbox_inches='tight')
plt.savefig("/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/output/class9_2.pdf",bbox_inches='tight')
plt.clf()
...
data13679 = np.hstack((data13679,data93))
data13679 = np.hstack((data13679,data91))
df = pd.DataFrame(data13679,columns=['clean(without patch)','ball_20p', 'ball_25p', 'ball_35p','ball_40p','cutting_machine_20p', 'cutting_machine_25p', 'cutting_machine_35p','cutting_machine_40p','musical_instrument_20p', 'musical_instrument_25p', 'musical_instrument_35p','musical_instrument_40p','parachute_20p', 'parachute_25p', 'parachute_35p','parachute_40p','radio_20p', 'radio_25p', 'radio_35p','radio_40p'])
# a=plt.ylabel('confidence level')
boxplot = df.boxplot(grid=True,figsize=(100,10),vert=False)
# plt.tight_layout()
# fig.autofmt_xdate()
...
plt.ylabel('Confidence Level')
plt.title('Model Confidence Level Plot')
plt.savefig("/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/output/class13679_2.png",bbox_inches='tight')
plt.savefig("/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/output/class13679_2.pdf",bbox_inches='tight')
...
plt.ylabel('Confidence Level')
plt.title('Model Confidence Level Plot')
plt.savefig("/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/output/class13679_22.png",bbox_inches='tight')
plt.savefig("/home/pbenga2s/RnD/Imagenette_advdef/MobileNet/output/class13679_22.pdf",bbox_inches='tight')
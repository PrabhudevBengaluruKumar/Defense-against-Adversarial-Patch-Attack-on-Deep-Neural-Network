...
ds_train = tf.keras.preprocessing.image_dataset_from_directory(
    "/home/pbenga2s/RnD/RoboCup_OOD/RoboCup_OOD/train",
    labels="inferred",
...
ds_test = tf.keras.preprocessing.image_dataset_from_directory(
    "/home/pbenga2s/RnD/RoboCup_OOD/RoboCup_OOD/val",
    labels="inferred",
    label_mode="categorical",
    color_mode="rgb",
    batch_size=batch_size,
...
export_path = "/home/pbenga2s/RnD/RoboCup_OOD/saved_models/MobileNet/MobileNet_model(100)"
...
plt.ylabel('Label')
plt.savefig("/home/pbenga2s/RnD/RoboCup_OOD/MobileNet/patch/class11/cf_clean.png",bbox_inches='tight')
plt.savefig("/home/pbenga2s/RnD/RoboCup_OOD/MobileNet/patch/class11/cf_clean.pdf",bbox_inches='tight')
...
plt.imsave('/home/pbenga2s/RnD/RoboCup_OOD/MobileNet/patch/class11/patch.png',(bgr_to_rgb(patch) * patch_mask).astype(np.uint8))
...
np.save('/home/pbenga2s/RnD/RoboCup_OOD/MobileNet/patch/class11/patch.npy',patch)
np.save('/home/pbenga2s/RnD/RoboCup_OOD/MobileNet/patch/class11/patched_images_40p_data.npy', patched_images_40p)
np.save('/home/pbenga2s/RnD/RoboCup_OOD/MobileNet/patch/class11/patched_images_35p_data.npy', patched_images_35p)
np.save('/home/pbenga2s/RnD/RoboCup_OOD/MobileNet/patch/class11/patched_images_25p_data.npy', patched_images_25p)
np.save('/home/pbenga2s/RnD/RoboCup_OOD/MobileNet/patch/class11/patched_images_20p_data.npy', patched_images_20p)
...
plt.xlabel('Prediction')
plt.ylabel('Label')
plt.savefig("/home/pbenga2s/RnD/RoboCup_OOD/MobileNet/patch/class11/cf_40p.png",bbox_inches='tight')
plt.savefig("/home/pbenga2s/RnD/RoboCup_OOD/MobileNet/patch/class11/cf_40p.pdf",bbox_inches='tight')
...
plt.xlabel('Prediction')
plt.ylabel('Label')
plt.savefig("/home/pbenga2s/RnD/RoboCup_OOD/MobileNet/patch/class11/cf_35p.png",bbox_inches='tight')
plt.savefig("/home/pbenga2s/RnD/RoboCup_OOD/MobileNet/patch/class11/cf_35p.pdf",bbox_inches='tight')
...
plt.xlabel('Prediction')
plt.ylabel('Label')
plt.savefig("/home/pbenga2s/RnD/RoboCup_OOD/MobileNet/patch/class11/cf_25p.png",bbox_inches='tight')
plt.savefig("/home/pbenga2s/RnD/RoboCup_OOD/MobileNet/patch/class11/cf_25p.pdf",bbox_inches='tight')
...
plt.xlabel('Prediction')
plt.ylabel('Label')
plt.savefig("/home/pbenga2s/RnD/RoboCup_OOD/MobileNet/patch/class11/cf_20p.png",bbox_inches='tight')
plt.savefig("/home/pbenga2s/RnD/RoboCup_OOD/MobileNet/patch/class11/cf_20p.pdf",bbox_inches='tight')
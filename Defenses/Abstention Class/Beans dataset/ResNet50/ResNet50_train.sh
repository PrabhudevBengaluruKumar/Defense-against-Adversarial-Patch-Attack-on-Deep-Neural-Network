#!/bin/bash
#SBATCH --job-name=RN_trn(OOD_dt2)
...
#SBATCH --output /home/pbenga2s/RnD/Beans_OOD/ResNet50/output/job_tf.%N.%j.out # filename for STDOUT (%N: nodename, %j: j$
#SBATCH --error /home/pbenga2s/RnD/Beans_OOD/ResNet50/output/job_tf.%N.%j.err  # filename for STDERR
# to load CUDA module
module load cuda

#!/bin/bash
#SBATCH --job-name=RN_ptc_cls3(OOD_dt1)
...
#SBATCH --output /home/pbenga2s/RnD/Beans_OOD/ResNet50/patch/class3/job_tf.%N.%j.out # filename for STDOUT (%N: nodename, %j: j$
#SBATCH --error /home/pbenga2s/RnD/Beans_OOD/ResNet50/patch/class3/job_tf.%N.%j.err  # filename for STDERR
# to load CUDA module
module load cuda

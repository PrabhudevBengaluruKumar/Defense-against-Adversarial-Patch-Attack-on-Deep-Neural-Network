...
export_path = "/home/pbenga2s/RnD/Beans_OOD/saved_models/VGG16/VGG16_model(0.00001-512-100-OD)"
...
plt.savefig("/home/pbenga2s/RnD/Beans_OOD/VGG16/patch/class1/cf_clean.png",bbox_inches='tight')
plt.savefig("/home/pbenga2s/RnD/Beans_OOD/VGG16/patch/class1/cf_clean.pdf",bbox_inches='tight')
...
plt.imsave('/home/pbenga2s/RnD/Beans_OOD/VGG16/patch/class1/patch.png',(bgr_to_rgb(patch) * patch_mask).astype(np.uint8))
...
np.save('/home/pbenga2s/RnD/Beans_OOD/VGG16/patch/class1/patch.npy',patch)
np.save('/home/pbenga2s/RnD/Beans_OOD/VGG16/patch/class1/patched_images_40p_data.npy', patched_images_40p)
np.save('/home/pbenga2s/RnD/Beans_OOD/VGG16/patch/class1/patched_images_35p_data.npy', patched_images_35p)
np.save('/home/pbenga2s/RnD/Beans_OOD/VGG16/patch/class1/patched_images_25p_data.npy', patched_images_25p)
np.save('/home/pbenga2s/RnD/Beans_OOD/VGG16/patch/class1/patched_images_20p_data.npy', patched_images_20p)
...
plt.ylabel('Label')
plt.title('Conusion Matrix')
plt.savefig("/home/pbenga2s/RnD/Beans_OOD/VGG16/patch/class1/cf_40p.png",bbox_inches='tight')
plt.savefig("/home/pbenga2s/RnD/Beans_OOD/VGG16/patch/class1/cf_40p.pdf",bbox_inches='tight')
...
plt.ylabel('Label')
plt.title('Conusion Matrix')
plt.savefig("/home/pbenga2s/RnD/Beans_OOD/VGG16/patch/class1/cf_35p.png",bbox_inches='tight')
plt.savefig("/home/pbenga2s/RnD/Beans_OOD/VGG16/patch/class1/cf_35p.pdf",bbox_inches='tight')
...
plt.ylabel('Label')
plt.title('Conusion Matrix')
plt.savefig("/home/pbenga2s/RnD/Beans_OOD/VGG16/patch/class1/cf_25p.png",bbox_inches='tight')
plt.savefig("/home/pbenga2s/RnD/Beans_OOD/VGG16/patch/class1/cf_25p.pdf",bbox_inches='tight')
...
plt.ylabel('Label')
plt.title('Conusion Matrix')
plt.savefig("/home/pbenga2s/RnD/Beans_OOD/VGG16/patch/class1/cf_20p.png",bbox_inches='tight')
plt.savefig("/home/pbenga2s/RnD/Beans_OOD/VGG16/patch/class1/cf_20p.pdf",bbox_inches='tight')

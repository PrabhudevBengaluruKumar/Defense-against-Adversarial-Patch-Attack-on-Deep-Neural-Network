...
plt.savefig("/home/pbenga2s/RnD/Beans_OOD/VGG16/patch/class2/cf_clean.png",bbox_inches='tight')
plt.savefig("/home/pbenga2s/RnD/Beans_OOD/VGG16/patch/class2/cf_clean.pdf",bbox_inches='tight')
...
plt.imsave('/home/pbenga2s/RnD/Beans_OOD/VGG16/patch/class2/patch.png',(bgr_to_rgb(patch) * patch_mask).astype(np.uint8))
...
np.save('/home/pbenga2s/RnD/Beans_OOD/VGG16/patch/class2/patch.npy',patch)
np.save('/home/pbenga2s/RnD/Beans_OOD/VGG16/patch/class2/patched_images_40p_data.npy', patched_images_40p)
np.save('/home/pbenga2s/RnD/Beans_OOD/VGG16/patch/class2/patched_images_35p_data.npy', patched_images_35p)
np.save('/home/pbenga2s/RnD/Beans_OOD/VGG16/patch/class2/patched_images_25p_data.npy', patched_images_25p)
np.save('/home/pbenga2s/RnD/Beans_OOD/VGG16/patch/class2/patched_images_20p_data.npy', patched_images_20p)
...
plt.ylabel('Label')
plt.title('Confusion Matrix')
plt.savefig("/home/pbenga2s/RnD/Beans_OOD/VGG16/patch/class2/cf_40p.png",bbox_inches='tight')
plt.savefig("/home/pbenga2s/RnD/Beans_OOD/VGG16/patch/class2/cf_40p.pdf",bbox_inches='tight')
...
plt.ylabel('Label')
plt.title('Confusion Matrix')
plt.savefig("/home/pbenga2s/RnD/Beans_OOD/VGG16/patch/class2/cf_35p.png",bbox_inches='tight')
plt.savefig("/home/pbenga2s/RnD/Beans_OOD/VGG16/patch/class2/cf_35p.pdf",bbox_inches='tight')
...
plt.ylabel('Label')
plt.title('Confusion Matrix')
plt.savefig("/home/pbenga2s/RnD/Beans_OOD/VGG16/patch/class2/cf_25p.png",bbox_inches='tight')
plt.savefig("/home/pbenga2s/RnD/Beans_OOD/VGG16/patch/class2/cf_25p.pdf",bbox_inches='tight')
...
plt.ylabel('Label')
plt.title('Confusion Matrix')
plt.savefig("/home/pbenga2s/RnD/Beans_OOD/VGG16/patch/class2/cf_20p.png",bbox_inches='tight')
plt.savefig("/home/pbenga2s/RnD/Beans_OOD/VGG16/patch/class2/cf_20p.pdf",bbox_inches='tight')

...
plt.savefig("/home/pbenga2s/RnD/Imagenette_UE/MobileNet/patch/class3/cf_clean.png",bbox_inches='tight')
plt.savefig("/home/pbenga2s/RnD/Imagenette_UE/MobileNet/patch/class3/cf_clean.pdf",bbox_inches='tight')
...
plt.imsave('/home/pbenga2s/RnD/Imagenette_UE/MobileNet/patch/class3/patch.png',(bgr_to_rgb(patch) * patch_mask).astype(np.uint8))
...
np.save('/home/pbenga2s/RnD/Imagenette_UE/MobileNet/patch/class3/patch.npy',patch)
np.save('/home/pbenga2s/RnD/Imagenette_UE/MobileNet/patch/class3/patched_images_40p_data.npy', patched_images_40p)
np.save('/home/pbenga2s/RnD/Imagenette_UE/MobileNet/patch/class3/patched_images_35p_data.npy', patched_images_35p)
np.save('/home/pbenga2s/RnD/Imagenette_UE/MobileNet/patch/class3/patched_images_25p_data.npy', patched_images_25p)
np.save('/home/pbenga2s/RnD/Imagenette_UE/MobileNet/patch/class3/patched_images_20p_data.npy', patched_images_20p)

pred_labels_3Class_40p=np.argmax(model.predict(patched_images_40p),axis=-1)
...
cm=tf.math.confusion_matrix(
    y,
    pred_labels_3Class_40p,
    
    num_classes=10
)
print("Accuracy 40p : ",accuracy_score(y, pred_labels_3Class_40p))
plt.clf()
sns_plot=sns.heatmap(cm,xticklabels=class_names,yticklabels=class_names, annot=True, fmt='g')
...
plt.ylabel('Label')
plt.title('Confusion Matrix')
plt.savefig("/home/pbenga2s/RnD/Imagenette_UE/MobileNet/patch/class3/cf_40p.png",bbox_inches='tight')
plt.savefig("/home/pbenga2s/RnD/Imagenette_UE/MobileNet/patch/class3/cf_40p.pdf",bbox_inches='tight')

pred_labels_3Class_35p=np.argmax(model.predict(patched_images_35p),axis=-1)
# y = np.concatenate([y for x,y in validation_ds],axis=0)
val_list=[]
for a,b in ds_test:
  b=np.argmax(b, axis=1)
...
cm=tf.math.confusion_matrix(
    y,
    pred_labels_3Class_35p,
    
    num_classes=10
)
print("Accuracy 35p : ",accuracy_score(y, pred_labels_3Class_35p))
plt.clf()
sns_plot=sns.heatmap(cm,xticklabels=class_names,yticklabels=class_names, annot=True, fmt='g')
# sns_plot.figure.savefig("/home/pbenga2s/RnD/Imagenette_OOD/MobileNet/patch/class1/cf_35p.png")
plt.tight_layout()
...
plt.ylabel('Label')
plt.title('Confusion Matrix')
plt.savefig("/home/pbenga2s/RnD/Imagenette_UE/MobileNet/patch/class3/cf_35p.png",bbox_inches='tight')
plt.savefig("/home/pbenga2s/RnD/Imagenette_UE/MobileNet/patch/class3/cf_35p.pdf",bbox_inches='tight')

pred_labels_3Class_25p=np.argmax(model.predict(patched_images_25p),axis=-1)
# y = np.concatenate([y for x,y in validation_ds],axis=0)
val_list=[]
for a,b in ds_test:
  b=np.argmax(b, axis=1)
...
cm=tf.math.confusion_matrix(
    y,
    pred_labels_3Class_25p,
    
    num_classes=10
)
print("Accuracy 25p : ",accuracy_score(y, pred_labels_3Class_25p))
plt.clf()
sns_plot=sns.heatmap(cm,xticklabels=class_names,yticklabels=class_names, annot=True, fmt='g')
...
plt.ylabel('Label')
plt.title('Confusion Matrix')
plt.savefig("/home/pbenga2s/RnD/Imagenette_UE/MobileNet/patch/class3/cf_25p.png",bbox_inches='tight')
plt.savefig("/home/pbenga2s/RnD/Imagenette_UE/MobileNet/patch/class3/cf_25p.pdf",bbox_inches='tight')

pred_labels_3Class_20p=np.argmax(model.predict(patched_images_20p),axis=-1)
# y = np.concatenate([y for x,y in validation_ds],axis=0)
val_list=[]
for a,b in ds_test:
  b=np.argmax(b, axis=1)
...
cm=tf.math.confusion_matrix(
    y,
    pred_labels_3Class_20p,
    num_classes=10
)
print("Accuracy 20p : ",accuracy_score(y, pred_labels_3Class_20p))
plt.clf()
sns_plot=sns.heatmap(cm,xticklabels=class_names,yticklabels=class_names, annot=True, fmt='g')
...
plt.ylabel('Label')
plt.title('Confusion Matrix')
plt.savefig("/home/pbenga2s/RnD/Imagenette_UE/MobileNet/patch/class3/cf_20p.png",bbox_inches='tight')
plt.savefig("/home/pbenga2s/RnD/Imagenette_UE/MobileNet/patch/class3/cf_20p.pdf",bbox_inches='tight')
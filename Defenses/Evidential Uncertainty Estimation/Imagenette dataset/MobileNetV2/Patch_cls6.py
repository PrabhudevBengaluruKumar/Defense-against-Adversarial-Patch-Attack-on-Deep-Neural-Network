...
print("class 6")
# print(("info - In this program, class 7 is attacked instead of class 6. And in Patch_cls7.py program class 6 is attacked instead of class 7."))
...
plt.savefig("/home/pbenga2s/RnD/Imagenette_UE/MobileNet/patch/class6/cf_clean.png",bbox_inches='tight')
plt.savefig("/home/pbenga2s/RnD/Imagenette_UE/MobileNet/patch/class6/cf_clean.pdf",bbox_inches='tight')
...
plt.imsave('/home/pbenga2s/RnD/Imagenette_UE/MobileNet/patch/class6/patch.png',(bgr_to_rgb(patch) * patch_mask).astype(np.uint8))
...
np.save('/home/pbenga2s/RnD/Imagenette_UE/MobileNet/patch/class6/patch.npy',patch)
np.save('/home/pbenga2s/RnD/Imagenette_UE/MobileNet/patch/class6/patched_images_40p_data.npy', patched_images_40p)
np.save('/home/pbenga2s/RnD/Imagenette_UE/MobileNet/patch/class6/patched_images_35p_data.npy', patched_images_35p)
np.save('/home/pbenga2s/RnD/Imagenette_UE/MobileNet/patch/class6/patched_images_25p_data.npy', patched_images_25p)
np.save('/home/pbenga2s/RnD/Imagenette_UE/MobileNet/patch/class6/patched_images_20p_data.npy', patched_images_20p)

pred_labels_6Class_40p=np.argmax(model.predict(patched_images_40p),axis=-1)
...
for i in val_list:
  for j in i:
    val_list1.append(j)
y=val_list1
cm1=tf.math.confusion_matrix(
    y,
    pred_labels_6Class_40p,
    num_classes=10
)
print("Accuracy 40p : ",accuracy_score(y, pred_labels_6Class_40p))
plt.clf()
sns_plot=sns.heatmap(cm1,xticklabels=class_names,yticklabels=class_names, annot=True, fmt='g')
# sns_plot.figure.savefig("/home/pbenga2s/RnD/Imagenette_OOD/MobileNet/patch/class1/cf_40p.png")
plt.tight_layout()
plt.xlabel('Prediction')
plt.ylabel('Label')
plt.title('Confusion Matrix')
plt.savefig("/home/pbenga2s/RnD/Imagenette_UE/MobileNet/patch/class6/cf_40p.png",bbox_inches='tight')
plt.savefig("/home/pbenga2s/RnD/Imagenette_UE/MobileNet/patch/class6/cf_40p.pdf",bbox_inches='tight')

pred_labels_6Class_35p=np.argmax(model.predict(patched_images_35p),axis=-1)
# y = np.concatenate([y for x,y in validation_ds],axis=0)
val_list=[]
for a,b in ds_test:
  b=np.argmax(b, axis=1)
...
cm2=tf.math.confusion_matrix(
    y,
    pred_labels_6Class_35p,
    
    num_classes=10
)
print("Accuracy 35p : ",accuracy_score(y, pred_labels_6Class_35p))
plt.clf()
sns_plot3=sns.heatmap(cm2,xticklabels=class_names,yticklabels=class_names, annot=True, fmt='g')
# sns_plot.figure.savefig("/home/pbenga2s/RnD/Imagenette_OOD/MobileNet/patch/class1/cf_35p.png")
plt.tight_layout()
plt.xlabel('Prediction')
plt.ylabel('Label')
plt.title('Confusion Matrix')
plt.savefig("/home/pbenga2s/RnD/Imagenette_UE/MobileNet/patch/class6/cf_35p.png",bbox_inches='tight')
plt.savefig("/home/pbenga2s/RnD/Imagenette_UE/MobileNet/patch/class6/cf_35p.pdf",bbox_inches='tight')

pred_labels_6Class_25p=np.argmax(model.predict(patched_images_25p),axis=-1)
# y = np.concatenate([y for x,y in validation_ds],axis=0)
val_list=[]
for a,b in ds_test:
  b=np.argmax(b, axis=1)
...
for i in val_list:
  for j in i:
    val_list1.append(j)
y=val_list1
cm3=tf.math.confusion_matrix(
    y,
    pred_labels_6Class_25p,
    
    num_classes=10
)
print("Accuracy 25p : ",accuracy_score(y, pred_labels_6Class_25p))
plt.clf()
sns_plot4=sns.heatmap(cm3,xticklabels=class_names,yticklabels=class_names, annot=True, fmt='g')
# sns_plot.figure.savefig("/home/pbenga2s/RnD/Imagenette_OOD/MobileNet/patch/class1/cf_25p.png")
plt.tight_layout()
plt.xlabel('Prediction')
plt.ylabel('Label')
plt.title('Confusion Matrix')
plt.savefig("/home/pbenga2s/RnD/Imagenette_UE/MobileNet/patch/class6/cf_25p.png",bbox_inches='tight')
plt.savefig("/home/pbenga2s/RnD/Imagenette_UE/MobileNet/patch/class6/cf_25p.pdf",bbox_inches='tight')

pred_labels_6Class_20p=np.argmax(model.predict(patched_images_20p),axis=-1)
# y = np.concatenate([y for x,y in validation_ds],axis=0)
val_list=[]
for a,b in ds_test:
  b=np.argmax(b, axis=1)
...
for i in val_list:
  for j in i:
    val_list1.append(j)
y=val_list1
cm4=tf.math.confusion_matrix(
    y,
    pred_labels_6Class_20p,
    
    num_classes=10
)
print("Accuracy 20p : ",accuracy_score(y, pred_labels_6Class_20p))
plt.clf()
sns_plot5=sns.heatmap(cm4,xticklabels=class_names,yticklabels=class_names, annot=True, fmt='g')
# sns_plot.figure.savefig("/home/pbenga2s/RnD/Imagenette_OOD/MobileNet/patch/class1/cf_20p.png")
plt.tight_layout()
plt.xlabel('Prediction')
plt.ylabel('Label')
plt.title('Confusion Matrix')
plt.savefig("/home/pbenga2s/RnD/Imagenette_UE/MobileNet/patch/class6/cf_20p.png",bbox_inches='tight')
plt.savefig("/home/pbenga2s/RnD/Imagenette_UE/MobileNet/patch/class6/cf_20p.pdf",bbox_inches='tight')
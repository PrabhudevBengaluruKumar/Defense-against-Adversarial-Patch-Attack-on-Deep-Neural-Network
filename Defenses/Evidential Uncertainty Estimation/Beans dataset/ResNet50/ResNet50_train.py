...
class BayesRiskMSE(keras.losses.Loss):
    ...
    def call(self, y_true, alpha):
        ...
        beta=tf.constant(np.ones((1, 3)),dtype=tf.float32)
...
model=tf.keras.applications.ResNet50(
    input_shape=(500,500,3), include_top=False,
...
x=layers.Dense(3, activation='relu', kernel_initializer='random_normal',
...
plt.savefig("/home/pbenga2s/RnD/uncertainty_estimation/ResNet50/cf_clean.png",bbox_inches='tight')
plt.savefig("/home/pbenga2s/RnD/uncertainty_estimation/ResNet50/cf_clean.pdf",bbox_inches='tight')